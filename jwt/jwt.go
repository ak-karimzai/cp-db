...
func newUserInfo(userId, userRole string) *UserInfo {
	return &UserInfo{
		UserId:   userId,
		UserRole: userRole,
	}
...
func GenerateToken(id,
	role string) (string, *models.ResponseError) {
...
func ValidateToken(tokenString string) (*UserInfo,
	*models.ResponseError) {
	token, err := jwt.Parse(tokenString, func(
